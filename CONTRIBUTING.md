# Contributing to the Python companion to *Statistical Thinking for the 21st Century*
...
* [![Bug](https://img.shields.io/github/labels/statsthinking21/statsthinking21-python/bug)][link_bugs] *These issues point to problems in the project.*
...
1. **[Fork][link_fork] the [book repository][link_bookrepo] to your profile.**<br />
